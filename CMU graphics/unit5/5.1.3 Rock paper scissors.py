...
def drawWinner(leftMove, rightMove):
    ...
    if leftThrow.value == 'Rock' and rightThrow.value == 'Rock':
        Label("==",200,200,size=60)
    if leftThrow.value == 'Rock' and rightThrow.value == 'Paper':
        Label("<",200,200,size=60)
    if leftThrow.value == 'Paper' and rightThrow.value == 'Rock':
        Label(">",200,200,size=60)
    if leftThrow.value == 'Rock' and rightThrow.value == 'Scissors':
        Label(">",200,200,size=60)
    if leftThrow.value == 'Scissors' and rightThrow.value == 'Rock':
        Label("<",200,200,size=60)
    if leftThrow.value == 'Paper' and rightThrow.value == 'Paper':
        Label("==",200,200,size=60)
    if leftThrow.value == 'Scissors' and rightThrow.value == 'Scissors':
        Label("==",200,200,size=60)
    if leftThrow.value =='Scissors' and rightThrow.value == 'Paper':
        Label(">",200,200,size=60)
    if leftThrow.value == 'Paper' and rightThrow.value == 'Scissors':
        Label("<",200,200,size=60)
    pass
