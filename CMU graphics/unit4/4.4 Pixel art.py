#Press the arrow keys. Notice that the square with black border follows your key presses.
...
def placeRect(key):
    ...
    if (key=='space'):
        Rect(cursor.left, cursor.top, cursor.height, cursor.width, fill=cursor.fill)
    pass
