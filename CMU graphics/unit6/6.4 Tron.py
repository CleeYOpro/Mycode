...
def playerOffScreenTest():
    ...
    if(player.centerX>400 or player.centerX <0 or player.centerY>400 or player.centerY <0):
...
def movePlayer():
    ...
    if(player.offScreen==True or player.hitsShape(trail)):
        gameOver()
    else:
        trail.add(Rect(player.centerX,player.centerY,20,20,fill=rgb(70,75,220),align='center'))
